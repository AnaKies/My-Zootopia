...
def print_skin_types(unique_skin_types):
    """
    Displays the available skin types or an error message if no skin types are available.
...
def print_animals_without_skin_type(counter_animals_without_skin_type):
    ...
    if counter_animals_without_skin_type > 0:
        print(f"Attention! {counter_animals_without_skin_type} animals are not "
              f"included in the animals data "
...
def main():
    try:
        ...
        animals_with_selected_skin, counter_animals_without_skin_type = (
            collect_animals_with_selected_skin_type(selected_skin_type, animals_data))
